...
public class JuliusCaesarApp {
    ...
    public static char cipher (char ch, int key) {
        ...
        return (char) (c + 65);
        //η κωδικοποίηση είναι +- 65 . Αφαιρούμε 65 ρίσκουμε ποιος χαρακτήρας είναι και μετά ξανακρυπτογραφουμέ δηλαδή κάνουμε + 65
        // cipher = message + key % 26...
    }
    /*
    * Στην δεύτερη περίπτωση υπολογίζεται το αρχικό message*/
