...
public class Lotto5App {
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:\\Users\\Dell\\whatever\\lotto5in.txt"));
            ...
            int pivot = 0; //επειδής μπορεί να μην είναι και οι 49 γεμάτεσ θα δείχνει στην τελευταία θέση των πραγματικών στοιχείων που έχει μέσα (στην πρώτη ελεύθερη)
...
// εδώ δεν είχα το if πριν γράψω τη λούπα και δεν είχα ps.print αλλά souf.
     ...
     * @return true if the number of events is greater than or equal to a threshold limit.
     */
