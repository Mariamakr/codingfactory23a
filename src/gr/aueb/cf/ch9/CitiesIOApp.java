...
* country 2 city1, city2, city3
*
*
* και γράφρει κάθε γραμμή σε διαφορετικό output αρχείο*/
...
public class CitiesIOApp {
    public static void main(String[] args) {
        String line;
        String[] cities;
        File dir = new File("C:\\Users\\Dell\\whatever\\cities.txt");
        if (!dir.exists()) {
            if (!dir.mkdir()) {
        ...
        try (BufferedReader bf = new BufferedReader(new FileReader("C:\\Users\\Dell\\whatever\\cities.txt"))) {
